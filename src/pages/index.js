...
// import FirstScreen from "@/components/landingPage/firstScreen";
import Layout from '@/components/layout/header'
import Banner from '@/components/landingPage/banner'
// import ImageScroller from '@/components/landingPage/imageScroller'
...
export default function Home() {
  ...
  return (
    <>
     <Head>
  <title>Panchromatic Media | Creative Digital Solutions</title>
  <meta
    name="description"
    content="Panchromatic Media delivers innovative digital experiences, from scroll-driven websites to immersive 3D visuals. Explore our creative solutions for modern brands."
  />
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <link rel="icon" href="/favicon.ico" />

  {/* Open Graph for social sharing */}
  <meta property="og:title" content="Panchromatic Media | Creative Digital Solutions" />
  <meta
    property="og:description"
    content="Discover Panchromatic Media's expertise in creative UI/UX, React, and 3D web experiences."
  />
  ...
  <meta name="twitter:title" content="Panchromatic Media | Creative Digital Solutions" />
  <meta
    name="twitter:description"
    content="Creative digital experiences with Panchromatic Media — scroll-driven sites, 3D visuals, and modern UI."
  />
  <meta name="twitter:image" content="/preview.png" />
</Head>
      {/* <FirstScreen/> */}
      <div className="common-bg relative">
